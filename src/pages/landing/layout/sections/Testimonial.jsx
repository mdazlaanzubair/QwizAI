  ...
  return (
    <section id="testimonial" class="text-gray-600 body-font">
      <div class="container px-5 py-5 mx-auto">
        <h1 class="text-3xl font-bold sm:text-4xl text-gray-900 text-center">
        ...
        <div class="flex flex-wrap items-center">
          {content.testimonial.map((items) => (
            <div class="p-4 md:w-1/3 w-full">
              <div class="bg-gray-100 p-8 rounded shadow-md hover:shadow-xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  class="block w-5 h-5 text-indigo-600 mb-4"
                ...
                <p class="leading-relaxed mb-6">{items.comment}</p>
