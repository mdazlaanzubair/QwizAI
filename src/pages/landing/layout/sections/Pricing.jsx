    ...
    <section id="pricing" class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          <h1 class="text-3xl font-bold sm:text-4xl mb-2 text-gray-900">
            Pricing
          </h1>
        ...
        <div class="flex flex-wrap -m-4">
          <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
              ...
              <button class="mt-auto text-indigo-600 border-2 border-indigo-600 active:border-0 hover:text-white py-2 px-4 w-full focus:outline-none hover:bg-indigo-600 rounded">
                Get Started
              </button>
          ...
          <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div class="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
              ...
              <button class="mt-auto text-white bg-indigo-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-indigo-700 rounded">
                Buy Now
              </button>
              <p class="text-xs text-gray-500 mt-3">
                Literally you probably haven't heard of them jean shorts.
